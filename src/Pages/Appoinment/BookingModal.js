            ...
            <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                    ...
                    <form onSubmit={handleFrom} className='mt-5 grid grid-cols-1 gap-3 justify-items-center'>
                        ...
                        <input name='name' type="text" placeholder="Full Name" class="input input-bordered w-full" />
                        <input name='number' type="text" placeholder="Phone Number" class="input input-bordered w-full" />
